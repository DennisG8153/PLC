...
#     prediction_input_data, correct_prediction = lstm_prediction_data(data_to_predict, model_wrapper.days_to_train_on, model_wrapper.prediction_start_date)
#     prediction_input_data = np.append(prediction_input_data, data_to_predict.iloc[(len(data_to_predict) - model_wrapper.days_to_train_on - 1):len(data_to_predict),:]) # training data is 10 by 5
